...
bool HelloWorld::createBox2dWorld(bool debug) {
	...
	//바디를 생성해서 월드에 추가한다.
	this->addNewSprite(Vec2(240, 300), Size(50, 50), b2_dynamicBody, "Close.png", 0);
...
void HelloWorld::createSpring(Vec2 point, Size size) {
	...
	priJointDef.Initialize(body1, body2, body1->GetPosition(), b2Vec2(0, 1));
	priJointDef.collideConnected = false;
	priJointDef.lowerTranslation = 0;
	priJointDef.upperTranslation = 0.8;
	priJointDef.enableLimit = true;

	priJointDef.enableMotor = true;
	priJointDef.motorSpeed = 3;
	priJointDef.maxMotorForce = 2900;
