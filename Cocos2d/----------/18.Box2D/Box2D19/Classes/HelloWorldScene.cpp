...
bool HelloWorld::createBox2dWorld(bool debug) {
	...
	ropeJointDef1.localAnchorA = b2Vec2(1, 0);
	ropeJointDef1.localAnchorB = b2Vec2(-1, 0);
	ropeJointDef1.maxLength = 1;
	ropeJointDef1.collideConnected = false;
	_world->CreateJoint(&ropeJointDef1);

	ropeJointDef2.bodyA = body2;
	ropeJointDef2.bodyB = body3;
	ropeJointDef2.localAnchorA = b2Vec2(1, 1);
	ropeJointDef2.localAnchorB = b2Vec2(-1, 0);
	ropeJointDef2.maxLength = 1;
	ropeJointDef2.collideConnected = false;
	_world->CreateJoint(&ropeJointDef2);

	ropeJointDef3.bodyA = body3;
	ropeJointDef3.bodyB = body4;
	ropeJointDef3.localAnchorA = b2Vec2(1, 1);
	ropeJointDef3.localAnchorB = b2Vec2(-1, 0);
	ropeJointDef3.maxLength = 1;
	ropeJointDef3.collideConnected = false;
	_world->CreateJoint(&ropeJointDef3);

	ropeJointDef4.bodyA = body4;
	ropeJointDef4.bodyB = body5;
	ropeJointDef4.localAnchorA = b2Vec2(1, 1);
	ropeJointDef4.localAnchorB = b2Vec2(-1, 0);
	ropeJointDef4.maxLength = 1;
