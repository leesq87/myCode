...
bool HelloWorld::init()
{
	...
	auto item2 = MenuItemFont::create("pushScene Transition", CC_CALLBACK_1(HelloWorld::doPushSceneTran, this));
	item2->setColor(Color3B::BLUE);

	auto item3 = MenuItemFont::create("replaceScene", CC_CALLBACK_1(HelloWorld::doReplaceScene, this));
	item3->setColor(Color3B::BLUE);

	auto item4 = MenuItemFont::create("replaceScene Transition", CC_CALLBACK_1(HelloWorld::doReplaceSceneTran, this));
	item4->setColor(Color3B::BLUE);
