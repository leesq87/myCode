...
bool HelloWorld::createBox2dWorld(bool debug) {
	...
	b2Body *body0 = this->addNewSprite(Vec2(240, 160), Size(160, 60), b2_staticBody, nullptr, 0);

	b2Body *body1 = this->addNewSprite(Vec2(240 -22, 160), Size(40, 40), b2_dynamicBody, nullptr, 1);

	b2Body *body2 = this->addNewSprite(Vec2(240 + 22, 160), Size(40, 40), b2_dynamicBody, nullptr, 1);
	...
	//joint1을 생성하기 전에 위 모터의 속성들을 정의해야 한다.
