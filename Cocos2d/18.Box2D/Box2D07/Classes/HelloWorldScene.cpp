...
bool HelloWorld::createBox2dWorld(bool debug) {
	...
	body2 = this->addNewSprite(Vec2(100 + 2, winSize.height / 2 + 2), Size(40, 40), b2_dynamicBody, "Close.png", 0);
	...
	body4 = this->addNewSprite(Vec2(200 + 2, winSize.height / 2 + 2), Size(60, 60), b2_dynamicBody, "Close.png", 0);
