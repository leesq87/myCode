...
bool HelloWorld::createBox2dWorld(bool debug) {
	...
	//바디를 생성해서 월드에 추가한다.
	b2Body* body1 = this->addNewSprite(Vec2(240, 160), Size(32, 32), b2_staticBody, "test", 0);
	b2Body* body2 = this->addNewSprite(Vec2(140, 160), Size(32, 32), b2_dynamicBody, "test", 0);
	...
	revJointDef.motorSpeed = 10; // radians per second 
	revJointDef.maxMotorTorque = 35; // 회전력
